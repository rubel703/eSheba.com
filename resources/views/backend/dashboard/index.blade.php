...
@section('content')
        ...
        <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold">{{$appoinments->count()}}</h3>
                           <a href="{{route('viewappoinment')}}"> <p class="text-muted fs-13 mb-0">Total Appoinments</p></a>
                            {{-- <p class="text-muted mb-0 mt-2 fs-12">
                                <span class="icn-box text-success fw-semibold fs-13 me-1">
                                    <i class='fa fa-long-arrow-up'></i>42%</span>since last month
                            </p> --}}
                        </div>
                        <div class="col col-auto top-icn dash">
                            <div class="counter-icon bg-primary dash ms-auto box-shadow-primary">
                               <a href="{{route('viewappoinment')}}"> <svg xmlns="http://www.w3.org/2000/svg" class="fill-white" enable-background="new 0 0 24 24"
                                viewBox="0 0 24 24">
                                <path
        ...
        <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold">{{$doctors->count()}}</h3>
                            <a href="{{route('indexdoctor')}}"><p class="text-muted fs-13 mb-0">Total Doctors</p></a>
                            {{-- <p class="text-muted mb-0 mt-2 fs-12">
                        ...
                        <div class="col col-auto top-icn dash">
                            <div class="counter-icon bg-secondary dash ms-auto box-shadow-secondary">
                                <a href="{{route('indexdoctor')}}"><svg xmlns="http://www.w3.org/2000/svg" class="fill-white" enable-background="new 0 0 24 24"
                                    viewBox="0 0 24 24">
                                    <path
        ...
        <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold">{{$departments->count()}}</h3>
                           <a href="{{route('index')}}"> <p class="text-muted fs-13 mb-0">Total Departments</p></a>
                            {{-- <p class="text-muted mb-0 mt-2 fs-12">
                                <span class="icn-box text-success fw-semibold fs-13 me-1">
                        ...
                        <div class="col col-auto top-icn dash">
                            <div class="counter-icon bg-info dash ms-auto box-shadow-info">
                               <a href="{{route('index')}}"> <svg xmlns="http://www.w3.org/2000/svg" class="fill-white" enable-background="new 0 0 24 24"
                                viewBox="0 0 24 24">
                                <path
        ...
        <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold">{{$contacts->count()}}</h3>
                          <a href="{{route('viewcontact')}}">  <p class="text-muted fs-13 mb-0">Contact List</p></a>
                            {{-- <p class="text-muted mb-0 mt-2 fs-12">
                                <span class="icn-box text-success fw-semibold fs-13 me-1">
                                    <i class='fa fa-long-arrow-up'></i>
                                    9%</span>
                        ...
                        <div class="col col-auto top-icn dash">
                            <div class="counter-icon bg-warning dash ms-auto box-shadow-warning">
                               <a href="{{route('viewcontact')}}"> <svg xmlns="http://www.w3.org/2000/svg" class="fill-white" enable-background="new 0 0 24 24"
                                viewBox="0 0 24 24">
                                <path
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-12 col-lg-6 col-xl-8">
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="card-title">Services ways Revenue</h3>
                    <div class="ms-auto">
