...
<head>
    ...
    <!-- TITLE -->
    <title>eSheba - @yield('title')</title>
    ...
    <!--- FONT-ICONS CSS -->
    <link href="{{ asset('/') }}/assets/backend/plugins/icons/icons.css" rel="stylesheet" />
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block active">
                                    <span class="country-selector"><img alt="unitedstates"
                                            src="{{ asset('/') }}/assets/backend/images/flags/us_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="italy"
                                            src="{{ asset('/') }}/assets/backend/images/flags/italy_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="spain"
                                            src="{{ asset('/') }}/assets/backend/images/flags/spain_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="india"
                                            src="{{ asset('/') }}/assets/backend/images/flags/india_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="french"
                                            src="{{ asset('/') }}/assets/backend/images/flags/french_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="russia"
                                            src="{{ asset('/') }}/assets/backend/images/flags/russia_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="germany"
                                            src="{{ asset('/') }}/assets/backend/images/flags/germany_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="argentina"
                                            src="{{ asset('/') }}/assets/backend/images/flags/argentina_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="uae"
                                            src="{{ asset('/') }}/assets/backend/images/flags/uae_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="austria"
                                            src="{{ asset('/') }}/assets/backend/images/flags/austria_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="mexico"
                                            src="{{ asset('/') }}/assets/backend/images/flags/mexico_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="china"
                                            src="{{ asset('/') }}/assets/backend/images/flags/china_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="poland"
                                            src="{{ asset('/') }}/assets/backend/images/flags/poland_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="canada"
                                            src="{{ asset('/') }}/assets/backend/images/flags/canada_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="malaysia"
                                            src="{{ asset('/') }}/assets/backend/images/flags/malaysia_flag.jpg"
                                ...
                                <div class="m-0 wp-70 text-dark d-flex align-items-center">
                                    <div class="me-2">
                                        <img alt="User Avatar" class="rounded-circle avatar-sm"
                                            src="{{ asset('/') }}/assets/backend/images/users/7.jpg">
                                    </div>
                                    <div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2">
                                                            <img alt="User Avatar" class="rounded-circle avatar-md"
                                                                src="{{ asset('/') }}/assets/backend/images/users/8.jpg">
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2">
                                                            <img alt="User Avatar" class="rounded-circle avatar-md"
                                                                src="{{ asset('/') }}/assets/backend/images/users/11.jpg">
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2">
                                                            <img alt="User Avatar" class="rounded-circle avatar-lg"
                                                                src="{{ asset('/') }}/assets/backend/images/users/14.jpg">
                                                        </div>
                                                        <div>
